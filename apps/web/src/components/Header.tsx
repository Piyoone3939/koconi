    ...
    >
      <div className="max-w-[1440px] mx-auto px-4 md:px-6 lg:px-8 py-3 md:py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6 lg:gap-8">
          <button onClick={() => scrollToSection('about')} className="text-[#B0BEC5] hover:text-[#EF6C00] transition-colors">About</button>
          <button onClick={() => scrollToSection('features')} className="text-[#B0BEC5] hover:text-[#EF6C00] transition-colors">Features</button>
          <button onClick={() => scrollToSection('download')} className="text-[#B0BEC5] hover:text-[#EF6C00] transition-colors">Download</button>
          <motion.div
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
            <Button onClick={() => scrollToSection('download')} className="bg-[#EF6C00] hover:bg-[#E65100] text-white rounded-full px-4 lg:px-6 py-2 shadow-lg text-sm">
              今すぐ始める
            </Button>
          </motion.div>
        </nav>
      ...
      >
        <nav className="flex flex-col gap-4 px-4 py-6">
          <button 
            ...
            className="text-[#B0BEC5] hover:text-[#EF6C00] transition-colors py-2 text-left"
          >
            About
          </button>
          <button 
